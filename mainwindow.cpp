...
QString MainWindow::GetFirstLetter(const QString &src)
{
    wchar_t wchr;
    QString firstLetter;
    if(src.size() > 0)
...
QString MainWindow::GetFirstLetters(const QString &src)
{
...
QString MainWindow::GetPinyins(const QString &text)
{
    QString pinyins;
...
QString MainWindow::GetPinyin(int code)
{
    QString pinyin;
    switch(code)
    {
    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(ui->pushButton,&QPushButton::clicked,[this]{
        ...
        QString pinyin = GetPinyins(text);
